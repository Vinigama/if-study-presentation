...
class GeradorCertificado:
    ...
    DIR_IMAGEM_BASE = os.path.join(__dirname, 'modelo.png')
    FONT_SMALL      = ImageFont.truetype(os.path.join(__dirname, 'fonts/Roboto-Light.ttf'), 15)
    FONT_DEFAULT    = ImageFont.truetype(os.path.join(__dirname, 'fonts/Roboto-Light.ttf'), 30)
    FONT_NOME       = ImageFont.truetype(os.path.join(__dirname, 'fonts/Roboto-Light.ttf'), 60)
