                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding-left:32px; font-family: Arial;">
                                    <p><strong>Descrição:</strong> Olá! Gostariamos de informá-lo que o seu perfil "{perfil}" precisa ser editado pelo motivo das altas sinalizações efetuadas pelos membros da comunidade</p> 
                                    <p>
                                    </br>
