...
<head>
    ...
    <title>Rejeição de conteúdo</title>
</head>
<body>
            ...
            <tr>
                <td align="center">
                    ...
                    <font style="font-size:19px; font-family: Arial; font-weight:bold;">
                        Conteúdo rejeitado pelo administrador
                    </font>
                </td>
            </tr>
            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding-left:32px; font-family: Arial;">
                                    <p><strong>Descrição: </strong> Olá! Gostariamos de informá-lo que a solitação referente ao conteúdo com título "{titulo_conteudo}" foi rejeitado pela administração</p>
                                    </br>
                                    <h3>Sobre a solicitação</h3>
                                    <p><strong>Conteúdo: </strong> {titulo_conteudo}</p>
                                    <p><strong>Tipo: </strong>{tipo_solicitacao}</p>
                                    <p><strong>Solicitado em: </strong>{data_solicitacao}</p>
                                    <p><strong>Motivo para a rejeição: </strong>{motivo_rejeicao}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
