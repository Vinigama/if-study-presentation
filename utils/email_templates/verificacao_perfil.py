                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding-left:32px; font-family: Arial;">
                                    ...
                                    <p>
                                    Para comentar e compartilhar na comunidade é de extrema importância ativar o seu perfil.Clique no botão abaixo para confirmar seu cadastro
                                    </p>
                                    <a href="http://{domain}/perfil/ativar/{uid}/{token}/">
                                        <button style="height:40px; width:150px; background-color:#064F23; border:none; border-radius:5px; cursor: pointer;">
